...
export const BESTIARY = {
  ...
  boss_002: {
    ...
    lore: "Pyrevex was never native to Aetheria - Yelena Morozova identified the wrongness in his signature the instant the caldera erupted, and she was right to be alarmed. He is a drake forged from volcanic rock and dimensional heat that has nothing to do with any world's natural geology, which means somewhere else, in some other reality, an entire ecosystem of magma-forged predators like him may still exist. His arrival in Aetheria's second chapter - right on the heels of Lysha's rift-born invasion - was the first sign that the shattered barrier wasn't a single wound. It was a door, and more than one thing on the other side had already noticed it was open.",
  },

  // ── CHAPTER 3: DAWN OF RADIANCE ────────────────────────────────────────────
  mob_005: {
    epithet: 'Forsaken Warden',
    lore: "Forest Wardens were sworn protectors of Sunspire's sacred light shrines for generations before the corruption reached them - their devotion never wavered, only its target did. Yelena Morozova put it plainly: their loyalty was simply redirected to a new master. They still fight with every technique they were trained to use in defense of the light. They just no longer remember what the light was originally for.",
  },
  mob_006: {
  ...
  'mini-boss_007': {
    ...
    lore: "The Prophet doesn't fight blind - he reads futures, which is exactly why Ash Renn's counter-strategy was to abandon patterns entirely and fight on pure instinct. Omen Null felt something immense waking on the other side of the gate the moment the Prophet's forces engaged, and it's since become clear the Prophet's foresight wasn't a personal gift. It was borrowed from something that could already see centuries ahead - the same something Omen Null would recognize, with far more history than he'd ever shared, one stage later.",
  },
  boss_007: {
    epithet: 'The Abyss Sovereign',
    lore: "Omen Null's words at the obsidian throne's descent were the shortest and heaviest of the entire chapter: this is what took everything from me. The Abyss Sovereign is ancient even by the standards of the multiversal threats the heroes had already faced - Lysha and Pyrevex were incursions from elsewhere, but the Sovereign's obsidian throne descending through Aetheria's own torn sky suggested a far older, far more personal connection to this world specifically, and to the man who fought him with nothing held back.",
  },

  // ── CHAPTER 8: ECLIPSE RISING ──────────────────────────────────────────────
  mob_012: {
    epithet: 'Dark Huntress',
    lore: "Dark Huntresses flank rather than charge, disciplined enough that Lyra Frost immediately clocked someone commanding the Eclipse vanguard with real military coordination. They hunt in the dimming light with patience the Stormbreaker Titans they march alongside completely lack - precision predators serving a sky that was going dark on purpose.",
  },
  'mini-boss_004': {
    epithet: 'The Void Samurai Warlord',
    lore: "Shade Vex named the danger precisely: his blade cuts through dimensional barriers, which makes every conventional defense the heroes have irrelevant to him. But Guren Tide saw the deeper truth - he honors the fight, refusing cheap tricks even against enemies he could dismantle with them. Ash Renn's read was the one that mattered most: a warrior who fights with honor can be outfought with skill, not exploited. This first meeting would not be the last. A greater version of this same warlord waits at the very edge of existence, chapters from now, guarding a passage he believes should never be closed.",
  },
  boss_008: {
    epithet: 'The Radiant Dragon Emperor',
    lore: "Yelena Morozova's correction mattered: the Emperor doesn't merely use divine light, he IS divine light given physical form, ancient beyond any measure the heroes had available. His arrival proved something Aurariel's fall in Chapter Three had only hinted at - that holy radiance, unchecked and absolute, is every bit as capable of annihilation as the darkest void. Lyra Frost's counter-strategy, shadow and void techniques against a being of pure light, marked the first time the heroes fought fire with its precise opposite rather than matching element for element, a lesson that would matter again when they faced a being who'd fused both sides completely.",
  },

  // ── CHAPTER 9: CELESTIAL FRACTURE ──────────────────────────────────────────
  'mini-boss_008': {
    epithet: 'The Clockwork Commander',
    lore: "The Commander doesn't fight with instinct or rage - he calculates, reorganizing the battlefield mid-combat faster than human intuition can track. Lyra Frost found every gap the heroes exploited closed before they could reach it. Yelena Morozova found his one true weakness: his processing has a thermal limit, and pushed hard enough, his perfect calculations fail under overload - proof that even flawless order eventually breaks against enough coordinated chaos.",
  },
  boss_009: {
    epithet: 'Fusion of Light and Dark',
    lore: "Valkor is the first being the heroes encountered who had actually succeeded at what Mother Eclipse would later achieve naturally - merging perfect light and perfect darkness into one form. The difference, Omen Null realized too late to prevent the attempt, is that Valkor forced the synthesis rather than letting it settle: he absorbed both sides of the celestial fracture and tried to rewrite what reality allows by sheer will. Five factions stopping that rewrite before it completed was the first time unity itself - not any single element - was the thing that actually won the fight.",
  },

  // ── CHAPTER 10: VOID QUEEN'S REIGN ─────────────────────────────────────────
  'mini-boss_012': {
    epithet: 'The Nature Assassin',
    lore: "She moves through Queen Nythera's corrupted garden without disturbing a single petal, and Tara Wind's warning explained why nobody could hide from her there: she reads the plant network itself, feeling every heroes' position through the roots beneath their feet. What almost none of the heroes suspected at the time was that she wasn't the most dangerous member of her family. Fifteen chapters later, at the edge of everything named, they would meet her elder sister - and understand exactly where she learned this kind of patience.",
  },
  boss_010: {
    epithet: 'The Void Queen',
    lore: "Yelena Morozova's assessment of Nythera cuts to the heart of what makes her uniquely dangerous: she didn't conquer the celestial realm by force. She infected it, and it surrendered willingly. She is void energy given a throne, having absorbed dimensional power from every realm the abyss has ever touched - not a foreign invader smashing through a gate, but a slow, willing corruption that the celestial realm let happen to itself one compromise at a time.",
  },

  // ── CHAPTER 11: TITAN'S MARCH ──────────────────────────────────────────────
  'mini-boss_005': {
    epithet: 'The Infernal Berserker King',
    lore: "He doesn't walk toward a fight - Zane Ember watched him detonate in its direction. He feeds on pain, both the pain he inflicts and the pain he takes, which means every hit landed against him only makes him hungrier and stronger. Lyra Frost's read made the strategy obvious: long battles favor him completely, so the only safe fight against the Berserker King is one that ends before his rage has time to peak.",
  },
  boss_011: {
    epithet: 'The Infernal Titan King',
    lore: "Zane Ember called him basically unkillable under normal conditions, and at building-scale height with each footstep erasing landmarks centuries old, that assessment wasn't hyperbole. Tara Wind found the one flaw in his design - a volcanic core on his chest sustaining both his size and his heat - and Guren Tide's insight completed the plan: concentrated cold or void energy against that single point destabilizes the entire titan. Precision, not brute force, is what actually brings down something this size.",
  },

  // ── CHAPTER 12: TIME'S END ─────────────────────────────────────────────────
  'mini-boss_006': {
    epithet: 'The Frost Revenant Knight',
    lore: "He has died before Chronos's arrival at this battlefield - multiple times, each death recorded as another layer of frost on his armor. Yelena Morozova's diagnosis was the grim one: he can't truly die while Chronos still holds his timeline, because Chronos simply loops the death backward and rebinds him to service each time. Defeating him for good required something rarer than damage - enough simultaneous force to make the death total before the loop could reset it.",
  },
  boss_012: {
    epithet: 'The God of Time',
    lore: "Chronos doesn't fight to win in the moment - he fights by rewriting when the moment happened at all, undoing the heroes' victories as fast as they achieve them. Yelena Morozova's answer to Valen Riftwalker's question - how do you fight someone who controls when things happen? - was the only one that could possibly work: act in the exact instant he can't predict, before he has time to see it coming and erase it. Facing a literal god of time, chapters after facing gates, empires, and swarms, was the moment the war stopped being about strength and started being about acting faster than causality itself.",
  },

  // ── CHAPTER 13: ETERNAL WINTER ─────────────────────────────────────────────
  'mini-boss_013': {
    epithet: 'The Storm Siren Empress',
    lore: "Lyra Frost's correction to how the heroes understood her was essential: the Empress doesn't control storms. She IS the storm, her voice tuned to weather frequencies so precisely that each note calls lightning and each breath becomes blizzard. Yelena Morozova identified the one vulnerability in a being made of pure weather - interrupt the song before its crescendo, and the storm that depends on it collapses along with it.",
  },
  boss_013: {
    epithet: 'The Frostbound Monarch',
    lore: "The Monarch had been watching the entire war since before Chapter One, letting every other threat - Lysha, Pyrevex, Nyx, Nythera - test the heroes first while he studied and prepared. Lyra Frost's warning at the throne's approach was chilling in its precision: he had designed counters for every single Trump Card the heroes had ever used, built specifically around their exact abilities. His defeat marked what the heroes believed, in that moment, was the true end of the war - the culmination of everything five factions had earned through blood and sacrifice. History would prove that belief wrong almost immediately.",
  },

  // ── CHAPTER 14: CRIMSON EMPIRE ─────────────────────────────────────────────
  boss_014: {
    epithet: 'The Crimson Empress',
    lore: "Seraphine never fought the heroes directly until Chapter Fourteen - she simply waited and fed. Shade Vex's realization was devastating in hindsight: she'd been absorbing a fraction of the power from every Trump Card the heroes used since Chapter One, harvesting their victories as fuel for her own ascension. Valen Riftwalker named the truth plainly - Seraphine had engineered the entire war so the heroes would grow strong enough to be worth harvesting. Every previous villain, however dangerous, had unknowingly been charging this one.",
  },

  // ── CHAPTER 15: WORLD'S LAST HOUR ──────────────────────────────────────────
  boss_015: {
    epithet: 'The World Eater Leviathan',
    lore: "Omen Null's description carried the true weight of what the heroes were facing: the World Eater doesn't conquer or corrupt anything - it simply consumes, and it existed before the universe itself had a name to lose. Yelena Morozova's account of its history was absolute: every realm it has touched is gone, not conquered or corrupted but erased so completely that they were removed from having ever existed at all. It surfaced from the cosmic abyss having sent an entire herald of lesser threats ahead of it - antibodies clearing resistance before the main body ever had to arrive. Facing it meant fighting not to win in any conventional sense, but simply to remain real in a universe actively being eaten alive around them.",
  },

  // ── CHAPTER 16: CATHEDRAL OF CHAINS ────────────────────────────────────────
  mob_015: {
    epithet: 'Iron Shade Knight',
    lore: "These knights weren't Seraphine's, even though they guarded ground beneath her fallen palace - Shade Vex realized they answered to someone else entirely, someone Seraphine herself had kept chained in the cathedral basement. Their loyalty to Visalia predates the Crimson Empire that unknowingly grew on top of her.",
  },
  mob_016: {
  ...
  'mini-boss_014': {
    ...
    lore: "Zane Ember's realization mid-battle was uncomfortable: the ancient seals on the cathedral's stone pillars had been BINDING the Keeper, not decorating the architecture. Seraphine's fall cracked those foundations, and the heroes accidentally freed an earth guardian that had been sealed for centuries - meaning their victory in Chapter Fourteen had unintentionally caused the very threat they now had to put back down.",
  },
  boss_016: {
    epithet: 'The True Architect',
    lore: "Visalia predates Seraphine by centuries and was never her subordinate - Omen Null's realization at the cathedral altar reframed the entire Crimson Empire's history: Seraphine wasn't the architect of the war's cruelty. Visalia was, engineering every conflict, every empire, every battle from the shadows while feeding on the collective bloodshed they generated. The Crimson Empire had been drawing from Visalia's reservoir the entire time without ever knowing it existed. Everything Seraphine harvested from the heroes' Trump Cards ultimately flowed to her.",
  },

  // ── CHAPTER 17: THE HOLLOW CROWN ───────────────────────────────────────────
  mob_019: {
    epithet: 'Void Wraith Archer',
    lore: "Soldiers of a kingdom erased so completely that no record, map, or memory acknowledges it ever existed. Omen Null called their resolve the kind that doesn't fade with death - they fight for a name and a history that history itself refuses to admit was real.",
  },
  mob_020: {
    epithet: 'Tomb Specter',
    lore: "Guardians of the erased kingdom's burial grounds, loyal to a throne with no name and a grievance with no official record. Guren Tide recognized the particular resolve in how they fight - like soldiers with something to prove not to an enemy, but to a world that pretended they never existed.",
  },
  'mini-boss_015': {
    epithet: 'Lady Silkgrave',
    lore: "Yelena Morozova identified her instantly beneath the crystal spider limbs and the royal funeral dress: she was the queen of the erased kingdom before history took both her and her king. Shade Vex's grim comparison explained the divergence in how the two of them survived erasure - the King became fury, consumed by rage at being forgotten. Silkgrave became something else entirely, weaving a perfectly preserved tomb kingdom in the dark rather than raging against the world that discarded her, centuries of grief transformed into patient, silent architecture instead of vengeance.",
  },
  boss_017: {
    epithet: 'The Crownless King',
    lore: "Every name carved into his black-gold armor belongs to someone whose story was erased alongside his own - Omen Null understood immediately that he carries their weight because he refuses to let an entire kingdom be forgotten twice. The void where his face should be marks exactly where his identity was taken, leaving him certain only that he was wronged, and that the wrong was systematic rather than accidental. Shade Vex's warning proved correct: something this old and this specifically angry doesn't have a clean weakness to exploit. Only a will that had to be met with an equal and opposite one.",
  },

  // ── CHAPTER 18: DIVIDED HEAVEN ─────────────────────────────────────────────
  mob_021: {
    epithet: 'Dark Golem',
    lore: "Constructed by the volcanic monastery's forge-cultists as weapons rather than worshippers, built specifically to survive the heat of a goddess achieving perfect convergence. Zane Ember's read was correct - whoever built them wanted something that could stand near Mother Eclipse's awakening without melting, faith or devotion never a factor in the design.",
  },
  mob_022: {
  ...
  'mini-boss_016': {
    ...
    lore: "Once a holy knight, his faith was tested past its breaking point until it transformed into something molten - Ash Renn described the glowing cavity where his chest armor used to be, a cursed weapon literally forged from his own melted conviction. Zane Ember's grimmest observation was the truest one: he believes converting souls into fuel for Mother Eclipse's awakening is holy work. You cannot reason with devotion that has been refined this far beyond doubt - you can only oppose it with equal, unshaken conviction of your own.",
  },
  boss_018: {
    epithet: 'The Balanced Goddess',
    lore: "Mother Eclipse achieved what Celestial Valkor tried and failed to force nine chapters earlier - true, natural equilibrium between divine light and absolute darkness, two cosmic bodies merged into one being with neither side dominant. Omen Null, who had faced beings of pure void and witnessed entities of pure light separately, had never encountered anything like her: she transcends elemental categories entirely, existing in the space between all of them rather than as any single extreme. Shade Vex's assessment closed the door on ordinary strategy - no elemental advantage applies to something that embodies everything and its opposite simultaneously. Only total, unified commitment from every faction at once ever stood a chance.",
  },
  ...
  mob_023: {
    ...
    lore: "Ancient navigators whose cosmic charts originally drew the Archive Devourer to this location, now trapped inside its stacks forever. Omen Null's diagnosis was bleak: they're feeding the Devourer dimensional information on an endless loop, their life's navigational work consumed and repeated back to them as a cage rather than a legacy.",
  },
  mob_024: {
    epithet: 'Dimensional Rift Stalker',
    lore: "Lyra Frost identified them as the Archive's immune system given a body - creatures that attack anything entering the library without belonging to it. The heroes, by every definition the Stalkers could measure, did not belong there at all, which made every step deeper into the stacks a fight for the right to keep moving forward.",
  },
  'mini-boss_017': {
    epithet: 'The Void-Touched Navigator',
    lore: "An ancient sailor who mapped too many dimensions and brought too much of the void home with him - Shade Vex described the star maps carved permanently into his skin, a ghostly compass behind him that reads dimensions instead of directions. Yelena Morozova's realization was the tragic core of the fight: the Archive claimed him when his knowledge became valuable enough to partially consume, leaving him aware but bound to serve. Omen Null saw the opening in that - partial consumption means part of him is still present, still aware this is wrong, still hating every second of it.",
  },
  boss_019: {
    epithet: 'The Devourer of Knowledge',
    lore: "The Archive Devourer doesn't destroy the knowledge it consumes - Yelena Morozova was precise about the horror of it: it contains everything, every secret, every lost civilization's final recorded words, every spell ever written, all still trapped and aware somewhere inside it. Omen Null's warning before the final clash cut deepest: it had already read the heroes' complete history from a thousand different sources, meaning any documented technique or established pattern was already known and countered before it was even attempted. Shade Vex's answer - pure improvisation, giving it nothing that had ever appeared in any text - was the first time the heroes' greatest weapon against an ancient threat was simply doing something no one had ever written down before.",
  },
  ...
  'mini-boss_018': {
    ...
    lore: "Yelena Morozova recognized her as the First Dream's most beloved creation - made to be beautiful, to perform, to prove that the dream's capacity for joy had no limit. Lyra Frost noticed the cracks first: porcelain fractured from eons of maintaining a performance for a sleeping audience of exactly one. Omen Null's read on her resolve was the saddest truth in the entire encounter - she believes that if the dream ends, she ends with it, and will not willingly step aside from a stage she's guarded since before recorded history began. Valen Riftwalker's final act wasn't a killing blow so much as a mercy - giving a lonely, eternal performer the ending curtain she'd been building toward the entire time.",
  },
  boss_020: {
    epithet: 'The Dreaming Origin',
    lore: "The First Dream existed before the universe had rules, before cause and effect were invented, before anything anywhere had a name - Omen Null's assessment placed it below the void, below the shadow, below everything the heroes had previously understood as deep. It is the original consciousness that dreamed existence into being in the first place, and it was never evil in any sense that word could apply - it simply predates the concept entirely. The heroes' victory here wasn't destruction; destroying the dream would have unmade the reality it was dreaming, themselves included. It was persuasion - proving to something vast, ancient, and utterly without context for a world outside its own imagination that the dream it had made was worth continuing exactly as it was.",
  },

  // ── CHAPTER 21: SHADOW SOVEREIGN ───────────────────────────────────────────
  mob_027: {
    epithet: 'Shadow Feline',
    lore: "Scouts sent by the Shadow Sovereign to test the heroes' perimeter before she committed to a full assault - silent, fast, and utterly disposable in her eyes. Omen Null recognized immediately that these weren't random creatures but a deliberate probe, testing exactly how much resistance stood between the Sovereign and open war.",
  },
  mob_028: {
    epithet: 'Void Viper',
  ...
  mob_032: {
    ...
    lore: "Corrupted spellcasters who commune with murders of shadow-crows as living extensions of their own senses, scouting far ahead of the Shadow Sovereign's main forces. Valen Riftwalker's question after the vanguard fell - how far back does this go? - was aimed squarely at what these scouts represented: centuries of patient preparation the heroes hadn't even known was happening.",
  },
  'mini-boss_019': {
    epithet: 'The Kitsune Specter',
    lore: "Lyra Frost identified her as a fox spirit bound to the Shadow Sovereign's service, her consciousness split across nine phantom tails simultaneously - never fully present in any single place. Omen Null found the exploit: every fox spirit has a single node holding all nine phantoms together, and severing that node collapses the illusion completely. Finding that node while she moved at full speed required every ounce of coordination five factions had built across twenty prior chapters of fighting side by side.",
  },
  boss_021: {
    epithet: 'The Shadow Sovereign',
    lore: "She had been consolidating power in the dark realm since before any of the heroes were born, patient enough to wait three hundred years for the exact right moment to move. Shade Vex's realization was chilling in scope: she'd been absorbing shadow energy from every battle the heroes had ever fought, across every single prior chapter - every darkness they dispelled had fed her rather than weakened the dark as a whole. Yelena Morozova found the one thing shadow energy this vast had never been forced to absorb: pure, faction-unified light, five elements combined into something the Sovereign's centuries of preparation had never modeled. She planned for every scenario except total, genuine cooperation - which, as Omen Null noted, has always been the heroes' real edge against enemies who plan alone.",
  },

  // ── CHAPTER 22: THE COSMIC WEAVE ───────────────────────────────────────────
  mob_029: {
    epithet: 'Bone Harpy',
    lore: "Creatures that formed when cosmic energy from a dying star crystallized without structure or intention - Yelena Morozova's read was that these are by-products, not designed servants, evidence of just how much raw stellar material was being consumed and reshaped above the crystallized field.",
  },
  mob_030: {
    epithet: 'Crystal Drake',
    lore: "Smaller echoes of dead starlight given crude draconic form, drifting through the collapsed star field where Caelestra's cosmic weave was under construction. Ash Renn noticed the deliberate patterns in how they clustered - proof someone was shaping the star's remains into something with real intention, not merely letting the collapse scatter randomly.",
  },
  mob_031: {
  ...
  'mini-boss_020': {
    ...
    lore: "Omen Null's assessment was precise: she's spent her entire existence translating stellar collapse events into usable magical formulae, and what she guards is the culmination of that life's research. Shade Vex's correction mattered - she didn't build the cosmic weave herself. She found the theoretical blueprint for it inside a dying star's final light and handed the execution to someone capable of actually wielding that scale of power. She is the architect of the idea, not the force behind it - which made stopping her, rather than merely defeating her, the only way to ensure the theory could never be applied again.",
  },
  boss_022: {
    epithet: 'The Cosmic Weaver',
    lore: "Yelena Morozova named the scale of what Caelestra had done: she absorbed the memories of dying worlds, every civilization that burned out and every consciousness that reached for more than it could hold, keeping all of it rather than letting it fade with the stars that once housed it. Valen Riftwalker recognized this wasn't simple power - it was responsibility carried at a scale no single being should have to hold. Shade Vex's warning shaped how the heroes approached her: beings who absorb that much memory eventually lose track of which instincts are truly theirs and which were merely borrowed from the dead. She was not defeated so much as reminded - by five factions acting as one living, present voice - that one world still choosing to exist mattered more than all the preserved memory of a thousand that no longer did.",
  },

  // ── CHAPTER 23: DEMON GLACIER ──────────────────────────────────────────────
  'mini-boss_021': {
    epithet: 'Lysse the Youngest',
    lore: "Omen Null recognized her at once as the youngest of the Crimson sisters - the same ancient bloodline that produced Visalia, though younger by that lineage's standards still made her older than empires. Shade Vex's read explained her presence at the frozen underworld's threshold: the Crimson bloodline has always been drawn to things that refuse to die, and an ice demon sealed before recorded history is the most interesting specimen she's ever had access to. She wasn't serving Glacidra. She was studying her, using the chaos of the demon's emergence as cover for research the rest of her bloodline didn't yet know she was conducting.",
  },
  boss_023: {
    epithet: 'The Frost Demon',
    lore: "Something older than any written seal had been holding Glacidra beneath the ice - Yelena Morozova noted that whatever documentation once existed for her original sealing had either been lost or deliberately destroyed. Her frost is not weather or even cold in any conventional sense; Yelena's assessment was precise and alarming: it removes the possibility of heat from the fabric of space itself rather than merely lowering its temperature, corrupting the dimensional matter she touches permanently. Ash Renn found the only workable strategy against a being who changes the rules of physics simply by existing: don't fight the ice she generates. Fight her, the singular source all of it comes from, and let the corrupted zones re-stabilize on their own once that source is gone.",
  },

  // ── CHAPTER 24: THE ELDER CRIMSON ──────────────────────────────────────────
  'mini-boss_022': {
    epithet: 'The Fae Enchantress',
    lore: "Yelena Morozova's assessment cut through the Enchantress's pleasant smile immediately: her hexes aren't cast in the moment, they're ambient, layered into the Elder Crimson's domain for so many centuries that the air itself has become a passive weapon. Ash Renn understood the smile correctly - she knew the heroes couldn't approach conventionally, and let them see exactly enough of that certainty to make the fight feel lost before it started. It wasn't. Void disruption stripped the ambient saturation her enchantments needed to anchor to, proving even magic layered for millennia can be dismantled with the right kind of pressure.",
  },
  boss_024: {
    epithet: 'The Elder Crimson',
    lore: "Lady Lyssiel is the original source of the entire Crimson bloodline - everything Visalia became in the Cathedral of Chains, everything the youngest sister Lysse aspires to become, traces back to her. Omen Null's realization was the most unsettling of the whole encounter: she had been watching the heroes since Chapter One, observing every battle and every Trump Card and every alliance without ever once intervening, because she had simply been finishing her assessment of whether they were worth her attention at all. Shade Vex's answer to what that assessment concluded was the most dangerous compliment the heroes had ever received from an enemy - that they were, at last, worth fighting. Lady Lyssiel had watched every empire in Aetheria's history rise and fall from a domain older than any of them without ever once needing to move. She moved for this fight, and only this one.",
  },

  // ── CHAPTER 25: THE FIRST ENTITY ───────────────────────────────────────────
  'mini-boss_023': {
    epithet: 'Briar the Elder',
    lore: "Lyra Frost recognized the resemblance immediately - this was the elder sister of the Nature Assassin the heroes had faced fifteen chapters earlier in Queen Nythera's garden, except serving the primordial dark rather than any single sovereign's domain for far, far longer. Shade Vex understood her purpose precisely: she isn't an obstacle so much as a guardian of the boundary between the named world and the First Entity beyond it, testing through combat - the only language old enough for both sides of that threshold - whether the heroes were worthy of the conversation they were attempting to start. Yelena Morozova's insight shaped the whole fight: with Briar, the approach mattered as much as the outcome. Victory alone wasn't enough. Winning with discipline and genuine respect was what actually earned the right to pass.",
  },
  boss_025: {
    epithet: 'The Origin',
    lore: "Omen Null named it the First Entity: Aetheria's original inhabitant, older than the gods the heroes had already fought, older than the void, older than the very concept of darkness. It didn't create the world - it was simply already present when the world arrived. Yelena Morozova's clarification mattered more than any battle strategy: it isn't malevolent, because malevolence was invented long after it already existed. What it has instead is magnitude - so much more than everything else that its mere existence exerts pressure on reality itself. The heroes couldn't destroy something that predates the concept of destruction, and couldn't reason with it in a language that postdates it by an immeasurable margin. Shade Vex's answer was to communicate in something older than language: pure, undiluted existence at full intensity, every faction and every element at once, making the argument that a world this alive was worth leaving intact simply by refusing to stop living. And in its final moment - the detail that changed everything the heroes thought they understood about the scale of what they were fighting - the Origin didn't look at them at all. It looked upward, toward something even it had no name for. Something above everything it had ever known.",
  },

  // ── CHAPTER 26: VOID ETERNAL ───────────────────────────────────────────────
  'mini-boss_024': {
    epithet: 'The Chronomancer Eternal',
    lore: "Yelena Morozova's diagnosis was as vast as it was unsettling: he has lived through every possible version of this war, existing in countless overlapping timelines at once, and has already watched the heroes lose in most of them. Ash Renn's counter was the only strategy that could work against someone who has literally already seen every predictable outcome - become unpredictable, chaotic, pure instinct, giving him nothing stable across any timeline for his foresight to anchor to. He is the Void Eternal's warden precisely because he understands, better than any other guardian the heroes have faced, exactly how repetition can be turned into a weapon.",
  },
  boss_026: {
    epithet: 'The Living Absence',
    lore: "Shade Vex's description was the most precise definition any enemy in the war had ever received: the Void Eternal is not a ruler, and it is not a destroyer. It is the silence that follows every ending - what remains, structurally, once a story is finished being told. Yelena Morozova's warning carried the true stakes: if it succeeds, even the heroes' hard-won victories would be unmade entirely, leaving no legend, no story, and no echo of the resistance that came before. It fed on the fragments of every defeated foe the heroes had ever faced, reforming their history as ammunition against them - the war's past turned into a weapon aimed at its own future. The heroes' answer wasn't strategy. It was refusal - proof that something could endure even the deliberate erasure of everything that came before it.",
  },

  // ── CHAPTER 27: CELESTIAL RECKONING ────────────────────────────────────────
  'mini-boss_025': {
    epithet: 'Seraph of the Scales',
    lore: "Golden scales vast enough to weigh entire stars materialize wherever this Seraph chooses to stand - Omen Null's read on the imbalance was blunt: one side holds the order of the multiverse, the other holds the heroes alone. Shade Vex's rebuttal defined the heroes' entire philosophy against cosmic judgment: they had never been balanced, only ever the disruption, and the only strategy against a being built to measure was to overload the scale until it could no longer measure them at all.",
  },
  boss_027: {
    epithet: 'The Grand Reckoning',
    lore: "Yelena Morozova's assessment removed any comfort from the confrontation: the Grand Reckoning doesn't hate the heroes. It simply perceives their continued survival as an error in a cosmic equation that governs realities far beyond Aetheria alone. It represents the original judges - beings who maintain balance across multiple universes, and who had, until now, judged the heroes' repeated defiance of fate to be a threat worth correcting directly. Valen Riftwalker's answer reframed the entire fight: if survival itself was the error, then the heroes would simply become the glitch the equation could never successfully calculate away.",
  },

  // ── CHAPTER 28: SERAPHIC JUDGMENT ──────────────────────────────────────────
  'mini-boss_026': {
    epithet: 'Ophaniel the Vigilant',
    lore: "It doesn't walk - Yelena Morozova described it rotating into being, a sphere of interlocking rings lined with unblinking eyes. She identified it as a watcher-class seraph, its entire purpose built around observation, resorting to violence only when observation alone fails to deter an intruder. Lyra Frost's warning was specific: it had already seen every attack pattern the heroes possessed, predicting strikes before they landed. Shade Vex's counter - pure improvisation, nothing for it to have already catalogued - was the one language a thousand watching eyes had genuinely never learned to read.",
  },
  boss_028: {
    epithet: 'The Last Seraph',
    lore: "Highest of the herald choir sent ahead to judge whether the heroes' continued defiance had earned the right to be noticed by whatever the choir was truly protecting. Yelena Morozova's assessment made the stakes clear: beyond this seraph, there is no more judgment left in the choir's hierarchy to pass - only whatever waits on the other side of its verdict. Omen Null's read softened the confrontation without lessening it: it doesn't hate the heroes, and doesn't even fully register them as a threat. It simply needs to be certain, absolutely certain, before letting anything else beyond it notice they exist at all. And in the instant the Last Seraph fell, something ancient and unblinking, far above the light, finally opened its eyes toward the battlefield for the first time.",
  },

  // ── CHAPTER 29: THE SILENT VIGIL ───────────────────────────────────────────
  'mini-boss_027': {
    epithet: 'The Recording Eye',
    lore: "A single vast eye that formed where the earlier silent sentinels once stood, its pupil holding a perfect reflection of every battle the heroes had ever fought. Yelena Morozova's read on its purpose was unnerving in its detachment: it isn't attacking to win. It's attacking to see how the story ends before deciding whether that ending is even worth keeping in the record at all. Omen Null recognized the deeper shift - a being sworn only to watch had chosen, for the first time, to act, which meant something in the pattern it had been tracking across the entire war had finally changed enough to warrant intervention.",
  },
  boss_029: {
    epithet: 'The Silent Watcher',
    lore: "Sworn since the birth of the very first reality to observe and never interfere - no matter what it witnessed, no matter how easily it could have helped - the Silent Watcher had maintained an unbroken vow for longer than Omen Null could put a number to. Yelena Morozova understood exactly what its presence here meant: if it was finally choosing to act, the heroes weren't just another battle to it anymore. They were the exception it had decided was worth breaking a billion-year-old oath to intervene for. Its defeat wasn't the end of the mystery - it was confirmation that something, somewhere above even a being this ancient, had been worth warning about all along.",
  },

  // ── CHAPTER 30: BEYOND CREATION ────────────────────────────────────────────
  'mini-boss_028': {
    epithet: 'Echo of the One Above All',
    lore: "Not the source itself, but a fragment cast off from something that speaks and simply expects reality to obey - and Yelena Morozova's warning was the most important one of the entire final chapter: even this echo, a mere reflection of the true authority, was almost more than the heroes could withstand directly. Omen Null's framing put twenty-nine chapters of escalation into a single sentence: they had already fought the first being in creation and the eye that watches all things. Whatever waited beyond this echo had authored them both.",
  },
  boss_030: {
    epithet: 'The One Above All',
    lore: "It had no form, no name, and no single moment of arrival, because Yelena Morozova understood it had never truly been absent - it simply was, and always had been, above everything the heroes had ever called reality. Omen Null's final assessment placed the entire war in true perspective: the Origin the heroes fought in Chapter Twenty-Five was the first being inside creation. This is what stands outside it entirely - above the Origin, above the Silent Watcher who broke a billion-year vow just to warn them it existed. There is nothing higher than this in any reality the heroes could ever reach. It doesn't rule through malice and wouldn't end them out of cruelty; to something this far above every story ever told, the heroes were simply a chapter it hadn't yet decided the worth of. Valen Riftwalker's final answer, backed by every hero, every faction, and every Trump Card earned since the very first shattered barrier, wasn't a bid to replace what stood above all creation. It was proof - offered directly to the top of existence itself - that everything allowed to exist beneath it had been worth creating in the first place.",
  },
};
